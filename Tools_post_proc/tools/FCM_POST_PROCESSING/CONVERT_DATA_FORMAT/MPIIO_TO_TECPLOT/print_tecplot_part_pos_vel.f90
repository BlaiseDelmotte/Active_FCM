...
subroutine PRINT_TECPLOT_PART_POS_VEL(TIME,NP,XP,YP,ZP,UP,VP,WP,BINFLAG)
...
write(FILENAME,10100)'PART_POS_VEL_t_',trim(FILE_EXT),'.plt'

!!- Open file for tecplot format
III = TECINI110('Part'//NULCHAR,'XP YP ZP UP VP WP'//NULCHAR,trim(FILENAME)//NULCHAR, &
...
write(FILENAME,10100)'PART_POS_VEL_t_',TIME,'.dat'
...
10000 format (A,A)
20000 format ('VARIABLES = "X", "Y", "Z", "up", "vp", "wp"')
...
end subroutine PRINT_TECPLOT_PART_POS_VEL
