...
integer :: PART_START, PART_END, SAVE_START, SAVE_END
...
integer :: NB_DUMP_FILES_PART, NSAVES_MSD
...
!- Open file
open(unit=100,file='stat_choice_msd_rdf.in',status='old', iostat=ERR_STAT)
...
print*,'SAVE_END - SAVE_START +1= ' , SAVE_END- SAVE_START +1
...
TIME_VEC(NB_DUMP_FILES_PART+1) = (real(NCYCLEMAX)-1.0)*DTIME
...
! 3. TREAT DATA
!=====================================================================
call MSD_ONLY(SAVE_START, &
																					SAVE_END, &               
																					PART_START, &
																					PART_END, &
																					NSAVES_MSD, &
																					FCM_POS_NOPER_TIME(SAVE_START:SAVE_END,PART_START:PART_END,:) )
               
call RDF_ONLY(SAVE_START, &
																					SAVE_END, &               
																					PART_START, &
																					PART_END, &
																					LXMAX, &
																					RADMAX, &
																					FCM_POS_TIME(SAVE_START:SAVE_END,PART_START:PART_END,:) )    
print*,' '
...
end program TREAT_MSD_RDF_ONLY
