...
do K = ISTART(3),IEND(3)
 do J = ISTART(2),IEND(2)
  ...
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_XX(1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_XX(NX/2+1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
  ...
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_YY(1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_YY(NX/2+1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
   
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_YZ(1,J,K) = GAUSS_VAR * RS_STD_NODIAG *dsqrt(2.0)
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_YZ(NX/2+1,J,K) = GAUSS_VAR * RS_STD_NODIAG *dsqrt(2.0)
 
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_ZZ(1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
  call FCM_RANDOM_GAUSSIAN_VARIABLE(GAUSS_VAR)
  FCM_RS_ZZ(NX/2+1,J,K) = GAUSS_VAR * RS_STD_DIAG *dsqrt(2.0)
