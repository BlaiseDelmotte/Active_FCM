...
!!--------------------------------------------------------------------
!! 3.1.2. Read the right-hand-side of fluid momentum
!!--------------------------------------------------------------------
...
!- Define file name
write(FILENAME,10101)'rhs_uf',trim(FILE_EXT),'.ini'

!- Open file containing the last fluid velocity field
open(unit = 120, file = trim(FILENAME),form='unformatted')


read(120)TN, TNM1, TNM2
read(120)FSIZE(1),FSTART(1),FEND(1)
read(120)FSIZE(2),FSTART(2),FEND(2)
read(120)FSIZE(3),FSTART(3),FEND(3)

!- Read rhs at tn
read(120)(((RHS_UFOU(I,J,K,TN  ),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_UFOU(I,J,K,TNM1),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_UFOU(I,J,K,TNM2),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
...
!- Define file name
write(FILENAME,10101)'rhs_vf',trim(FILE_EXT),'.ini'
...
!- Read rhs at tn
read(120)(((RHS_VFOU(I,J,K,TN  ),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_VFOU(I,J,K,TNM1),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_VFOU(I,J,K,TNM2),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
...
!- Define file name
write(FILENAME,10101)'rhs_wf',trim(FILE_EXT),'.ini'
...
!- Read rhs at tn
read(120)(((RHS_WFOU(I,J,K,TN  ),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_WFOU(I,J,K,TNM1),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_WFOU(I,J,K,TNM2),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
...
if(MYID==0) write(*,*) 'Read rhs of fluid momentum --> Multiple Binary Files'
...
!!--------------------------------------------------------------------
!! 3.2.2. Read the right-hand-side of fluid momentum
!!--------------------------------------------------------------------
...
!!--------------------------------------------------------------------
 FILENAME='rhs_uf.ini'
 call READ_MPIIO_RHS(RHS_UFOU,FILENAME)

!!--------------------------------------------------------------------
!!- y-direction
!!--------------------------------------------------------------------
 FILENAME='rhs_vf.ini'
 call READ_MPIIO_RHS(RHS_VFOU,FILENAME)

!!--------------------------------------------------------------------
!!- z-direction
!!--------------------------------------------------------------------
 FILENAME='rhs_wf.ini'
 call READ_MPIIO_RHS(RHS_WFOU,FILENAME)
 if(MYID==0) write(*,*)'RHS initiation: Read from file --> OK'
