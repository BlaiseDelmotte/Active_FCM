...
subroutine FCM_COMPUTE_GAUSSIAN_ENV_FUNCTION(IND, XGLOB, FCM_ELL_GAUSS)
...
real(kind=8), intent(out) :: FCM_ELL_GAUSS  !< Global distance to center
...
!~     FCM_ELLIPSOID_DIP_GAUSS = FCM_ELLIPSOID_ANORM_DIP(IND)*dexp( &
...
!~     FCM_ELLIPSOID_GRAD_DIP_GAUSS1 = -( Q(1,1)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,1) &
!~                                      + Q(2,1)*XGLOB(2,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,2) &
!~                                      + Q(3,1)*XGLOB(3,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,3) )
!~                                                
!~ 
!~     FCM_ELLIPSOID_GRAD_DIP_GAUSS2 = -( Q(1,2)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,1) &
!~                                      + Q(2,2)*XGLOB(2,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,2) &
!~                                      + Q(3,2)*XGLOB(3,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,3) )  
!~                               
!~                             
!~     FCM_ELLIPSOID_GRAD_DIP_GAUSS3 = -( Q(1,3)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ_DIP(IND,1) &
...
end subroutine FCM_COMPUTE_GAUSSIAN_ENV_FUNCTION
