...
subroutine FCM_COMPUTE_GAUSSIAN_GRAD_ENV_FUNCTION(IND, &
                                                      XGLOB, &
                                                      Q, &
                                                      FCM_ELL_GRAD_GAUSS1, &
                                                      FCM_ELL_GRAD_GAUSS2, &
...
real(kind=8), intent(out) :: FCM_ELL_GRAD_GAUSS1  
real(kind=8), intent(out) :: FCM_ELL_GRAD_GAUSS2
real(kind=8), intent(out) :: FCM_ELL_GRAD_GAUSS3
...
FCM_ELL_GRAD_GAUSS1 = -( Q(1,1)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ(IND,1) &
                       + Q(2,1)*XGLOB(2,1)/FCM_ELLIPSOID_SIGSQ(IND,2) &
                       + Q(3,1)*XGLOB(3,1)/FCM_ELLIPSOID_SIGSQ(IND,3) )
                                           

FCM_ELL_GRAD_GAUSS2 = -( Q(1,2)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ(IND,1) &
                       + Q(2,2)*XGLOB(2,1)/FCM_ELLIPSOID_SIGSQ(IND,2) &
                       + Q(3,2)*XGLOB(3,1)/FCM_ELLIPSOID_SIGSQ(IND,3) )  
                          
                        
FCM_ELL_GRAD_GAUSS3 = -( Q(1,3)*XGLOB(1,1)/FCM_ELLIPSOID_SIGSQ(IND,1) &
...
end subroutine FCM_COMPUTE_GAUSSIAN_GRAD_ENV_FUNCTION
