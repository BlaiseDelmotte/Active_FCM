...
!!
!! LEVEL1_STFLU: + Mean velocity
!!               + Reynolds stresses
!!               + Kolmogorov's scales
!!               + Taylor's scale (Tg)
!!
!! LEVEL2_STFLU: + Divergence
!!               + Dissipation
!!
!! LEVEL3_STFLU: + Flatness coefficient
!!               + Skewness coefficient
!!               + Fluid velocity PDF
!!               + Fluid velocity gradient PDF
!!               + Taylor's scales
!!
!! LEVEL4_STFLU: + Autocorrelation function f & g
...
!!- Dissipation
 call RSUMCPU(EPS_FLU,MEAN_FLUID(11))
...
!!======================================================================
if(LEVEL4_STFLU.and.STAT_TIME) then
!
!
