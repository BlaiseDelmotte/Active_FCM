...
!~ if (MYID==0) then
!~  print*, ' FCM_SPHERE_SIGMA = ', FCM_SPHERE_SIGMA
!~  print*, 'FCM_SPHERE_RADP = ', FCM_SPHERE_RADP
!~  print*,'FCM_SPHERE_RADP/DX = ', FCM_SPHERE_RADP/DX 
!~  print*,'FCM_SPHERE_SIGSQ = ', FCM_SPHERE_SIGSQ
!~  print*,'FCM_SPHERE_ANORM_POTDIP = ', FCM_SPHERE_ANORM_POTDIP
!~  read(*,*)
!~ end if
