...
!!--------------------------------------------------------------------
!- Define file name
write(FILENAME,10200)'rhs_scl',trim(FILE_EXT),'.ini'
...
!- Drop rhs
read(120)(((RHS_SCL(I,J,K,TN  ),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_SCL(I,J,K,TNM1),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))
read(120)(((RHS_SCL(I,J,K,TNM2),I=FSTART(1),FEND(1)),J=FSTART(2),FEND(2)),K=FSTART(3),FEND(3))

!- Close file
close(120)

if(MYID==0) write(*,*) 'Read rhs of scalar --> Multiple Binary Files'
...
!- RHS of scalar field
 FILENAME='rhs_scl.ini'
 call READ_MPIIO_RHS(RHS_SCL,FILENAME)
