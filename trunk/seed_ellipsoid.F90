...
real(kind=8),dimension(3) :: RANDNUM_QUAT
...
!! Generate random quaternion according to http://planning.cs.uiuc.edu/node198.html
!! citing 
!! K. Shoemake.
...
!! In D. Kirk, editor, Graphics Gems III, pages 124-132. Academic, New York, 1992. 
 ...
 call init_random_seed()
 call random_number(RANDNUM_AXIS)
 
 QUAT1 = dsqrt(1.0-RANDNUM_AXIS(1))*sin(2.0*PPI*RANDNUM_AXIS(2))
