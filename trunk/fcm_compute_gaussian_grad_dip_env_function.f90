...
subroutine FCM_COMPUTE_GAUSSIAN_GRAD_DIP_ENV_FUNCTION(IND, &
                                                      XGLOB, &
                                                      Q, &
                                                      FCM_ELL_GRAD_DIP_GAUSS1, &
                                                      FCM_ELL_GRAD_DIP_GAUSS2, &
                                                      FCM_ELL_GRAD_DIP_GAUSS3  )
...
real(kind=8), intent(out) :: FCM_ELL_GRAD_DIP_GAUSS1  
real(kind=8), intent(out) :: FCM_ELL_GRAD_DIP_GAUSS2
real(kind=8), intent(out) :: FCM_ELL_GRAD_DIP_GAUSS3
...
end subroutine FCM_COMPUTE_GAUSSIAN_GRAD_DIP_ENV_FUNCTION
